...
void construct_eapol_start_frame(const uint8_t *frame)
{
  ...
  const uint8_t ethernet_padding[] = {0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, /* ....7w.. */
                                      0xf7, 0xff, 0xe5, 0x00, 0x00, 0x00, 0xff, 0xaf, /* ..!..... */
                                      0xf7, 0xff, 0x80, 0xff, 0xff, 0xff, 0xff, 0x5d, /* .......] */
                                      0xbf, 0x00, 0x00, 0x13, 0x11, 0x38, 0x30, 0x32, /* .....802 */
    ...
    const uint8_t ethernet_trailer[] = {0x00, 0x00, 0x00, 0x00, /* ........ */
                                        ...
                                        0x13, 0x11, 0x2d, 0x08, 0x08, 0x00, 0x27, 0x8b, /* ..-...'. */
                                        0xa5, 0x8a, 0x1a, 0x08, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                        ...
                                        0x8b, 0xa5, 0x8a, 0x1a, 0x18, 0x00, 0x00, 0x13, /* ........ */
                                        ...
                                        0x11, 0x54, 0x42, 0x56, 0x42, 0x66, 0x38, 0x34, /* .TBVBf84 */
                                        0x65, 0x37, 0x35, 0x66, 0x62, 0x2d, 0x33, 0x66, /* e75fb-3f */
                                        0x34, 0x33, 0x30, 0x62, 0x63, 0x38, 0x20, 0x00, /* 430bc8 . */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
//  uint8_t eap_id = 0x01; // default 0x01, 详见 RFC 3748
    const uint8_t ethernet_padding[] = {0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, 0xf7, 0xff, /* ..7w.... */
                                        0xe5, 0x00, 0x00, 0x00, 0xff, 0xaf, 0xf7, 0xff, /* !....... */
                                        0x80, 0x43, 0x26, 0xb7, 0x87, 0xca, 0x9e, 0x00, /* .....].. */
                                        0x00, 0x13, 0x11, 0x38
    };
    ...
    const uint8_t ethernet_trailer[] = {0x30, 0x32, 0x31, 0x78, /* ...8021x */
                                        ...
                                        0x2d, 0x08, 0x08, 0x00, 0x27, 0x8b, 0xa5, 0x8a, /* -...'... */
                                        ...
                                        0x00, 0x0a, 0x00, 0x27, 0xff, 0xfe, 0x8b, 0xa5, /* ...'.... */
                                        0x8a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x4e, /* .......N */
                                        0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        ...
                                        0x42, 0x56, 0x42, 0x66, 0x38, 0x34, 0x65, 0x37, /* BVBf84e7 */
                                        0x35, 0x66, 0x62, 0x2d, 0x33, 0x66, 0x34, 0x33, /* 5fb-3f43 */
                                        0x30, 0x62, 0x63, 0x38, 0x20, 0x00, 0x00, 0x00, /* 0bc8 ... */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
{
  const uint16_t EAP_RESPONSE_MD5_CHALLENGE_LENGTH  = 571;  // send to server packet length
...
//uint8_t eap_response_md5_value[EAP_MD5_VALUE_LENGTH]; // md5 calculation result
  ...
  extern unsigned int midnight_mode_change_tail_data;
    ...
    const uint8_t ethernet_padding[] = {0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, 0xf7, /* 6..7w... */
                                        0xff, 0xe5, 0x00, 0x00};
    const uint8_t ethernet_trailer[] = {   0x00, 0xff, 0xaf, 0xf7, /* .!...... */
                                           0xff, 0x80, 0xff, 0xff, 0xff, 0xff, 0x5d, 0xbf, /* ......]. */
                                           ...
                                           0x11, 0x2d, 0x08, 0x08, 0x00, 0x27, 0x8b, 0xa5, /* .-...'.. */
                                           0x8a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x2f, /* ......./ */
                                           0x12, 0xca, 0x73, 0x30, 0x22, 0x5b, 0xdb, 0xba, /* ..s0"[.. */
                                           0xe5, 0x46, 0xad, 0xe6, 0xc4, 0x52, 0xe6, 0xbc, /* .F...R.. */
                                           0x4a, 0x1a, 0x08, 0x00, 0x00, 0x13, 0x11, 0x76, /* J......v */
                                           ...
                                           0x00, 0x00, 0x0a, 0x00, 0x27, 0xff, 0xfe, 0x8b, /* ....'... */
                                           0xa5, 0x8a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                           0x4e, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* N....... */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x1a, 0x88, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                           0x4d, 0x82, 0x35, 0x36, 0x31, 0x34, 0x31, 0x66, /* M.56141f */
                                           0x38, 0x36, 0x35, 0x34, 0x65, 0x33, 0x33, 0x30, /* 8654e330 */
                                           0x39, 0x62, 0x64, 0x64, 0x64, 0x37, 0x30, 0x32, /* 9bddd702 */
                                           0x35, 0x33, 0x30, 0x30, 0x61, 0x66, 0x36, 0x66, /* 5300af6f */
                                           0x32, 0x61, 0x35, 0x66, 0x32, 0x34, 0x39, 0x33, /* 2a5f2493 */
                                           0x65, 0x34, 0x66, 0x65, 0x36, 0x35, 0x66, 0x31, /* e4fe65f1 */
                                           0x65, 0x66, 0x32, 0x36, 0x62, 0x66, 0x37, 0x34, /* ef26bf74 */
                                           0x34, 0x61, 0x36, 0x34, 0x65, 0x33, 0x33, 0x37, /* 4a64e337 */
                                           0x35, 0x34, 0x39, 0x33, 0x35, 0x66, 0x37, 0x30, /* 54935f70 */
                                           0x62, 0x31, 0x31, 0x65, 0x37, 0x30, 0x34, 0x65, /* b11e704e */
                                           0x35, 0x37, 0x61, 0x63, 0x65, 0x61, 0x62, 0x66, /* 57aceabf */
                                           0x30, 0x62, 0x31, 0x36, 0x31, 0x36, 0x35, 0x39, /* 0b161659 */
                                           0x32, 0x34, 0x61, 0x63, 0x61, 0x35, 0x39, 0x61, /* 24aca59a */
                                           0x61, 0x66, 0x35, 0x33, 0x65, 0x64, 0x35, 0x36, /* af53ed56 */
                                           0x64, 0x30, 0x38, 0x37, 0x35, 0x32, 0x38, 0x62, /* d087528b */
                                           0x35, 0x39, 0x32, 0x64, 0x64, 0x35, 0x32, 0x62, /* 592dd52b */
                                           0x38, 0x63, 0x1a, 0x28, 0x00, 0x00, 0x13, 0x11, /* 8c.(.... */
                                           0x39, 0x22, 0xd2, 0xc6, 0xb6, 0xaf, 0x00, 0x00, /* 9"...... */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x1a, 0x48, 0x00, 0x00, 0x13, 0x11, /* ...H.... */
                                           0x54, 0x42, 0x56, 0x42, 0x66, 0x38, 0x34, 0x65, /* TBVBf84e */
                                           0x37, 0x35, 0x66, 0x62, 0x2d, 0x33, 0x66, 0x34, /* 75fb-3f4 */
                                           0x33, 0x30, 0x62, 0x63, 0x38, 0x20, 0x00, 0x00, /* 30bc8 .. */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
