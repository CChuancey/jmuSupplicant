...
void construct_eapol_start_frame(const uint8_t *frame)
{
  ...
  const uint8_t ethernet_padding[] = {0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, /* ....7w.. */
                                      0xf7, 0xff, 0xe5, 0x00, 0xff, 0xff, 0xff, 0xaf, /* ........ */
                                      0xf7, 0xff, 0x80, 0x01, 0xff, 0xff, 0x53, 0x3e, /* ......S> */
                                      0x4a, 0x00, 0x00, 0x13, 0x11, 0x38, 0x30, 0x32, /* J....802 */
    ...
    const uint8_t ethernet_trailer[] = {0x00, 0x00, 0x00, 0x00, /* ........ */
                                        ...
                                        0x13, 0x11, 0x2d, 0x08, 0x08, 0x00, 0x27, 0x69, /* ..-...'i */
                                        0x25, 0x6a, 0x1a, 0x08, 0x00, 0x00, 0x13, 0x11, /* %j...... */
                                        0x2f, 0x02, 0x1a, 0x08, 0x00, 0x00, 0x13, 0x11, /* /....... */
                                        0x76, 0x02, 0x1a, 0x09, 0x00, 0x00, 0x13, 0x11, /* v....... */
                                        0x35, 0x03, 0x02, 0x1a, 0x18, 0x00, 0x00, 0x13, /* 5....... */
                                        ...
                                        0x00, 0x00, 0x00, 0x0a, 0x00, 0x27, 0xff, 0xfe, /* .....'.. */
                                        0x69, 0x25, 0x6a, 0x1a, 0x18, 0x00, 0x00, 0x13, /* i%j..... */
                                        ...
                                        0x11, 0x39, 0x22, 0xd2, 0xc6, 0xb6, 0xaf, 0x00, /* .9"..... */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x1a, 0x48, 0x00, 0x00, 0x13, /* ....H... */
                                        0x11, 0x54, 0x42, 0x56, 0x42, 0x34, 0x64, 0x39, /* .TBVB4d9 */
                                        0x65, 0x62, 0x64, 0x62, 0x65, 0x2d, 0x30, 0x64, /* ebdbe-0d */
                                        0x35, 0x64, 0x62, 0x32, 0x39, 0x36, 0x20, 0x00, /* 5db296 . */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
//  uint8_t eap_id = 0x01; // default 0x01, 详见 RFC 3748
    const uint8_t ethernet_padding[] = {0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, 0xf7, 0xff, /* ..7w.... */
                                        0xe5, 0x00, 0xff, 0xff, 0xff, 0xaf, 0xf7, 0xff, /* ........ */
                                        0x80, 0x01, 0xff, 0xff, 0x53, 0x3e, 0x4a, 0x00, /* ....S>J. */
                                        0x00, 0x13, 0x11, 0x38
    };

    const uint8_t ethernet_trailer[] = {0x30, 0x32, 0x31, 0x78, /* ...8021x */
                                        0x2e, 0x65, 0x78, 0x65, 0x00, 0x00, 0x00, 0x00, /* .exe.... */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x01, 0x1f, 0x01, 0x02, 0xd0, /* ........ */
                                        0x00, 0x00, 0x13, 0x11, 0x01, 0xb4, 0x1a, 0x0c, /* ........ */
                                        0x00, 0x00, 0x13, 0x11, 0x18, 0x06, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x1a, 0x0e, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                        0x2d, 0x08, 0x08, 0x00, 0x27, 0x69, 0x25, 0x6a, /* -...'i%j */
                                        ...
                                        0x02, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x36, /* .......6 */
                                        0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x38, /* .......8 */
                                        0x12, 0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x0a, 0x00, 0x27, 0xff, 0xfe, 0x69, 0x25, /* ...'..i% */
                                        0x6a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x4e, /* j......N */
                                        0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        ...
                                        0x22, 0xd2, 0xc6, 0xb6, 0xaf, 0x00, 0x00, 0x00, /* "....... */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x1a, 0x48, 0x00, 0x00, 0x13, 0x11, 0x54, /* ..H....T */
                                        0x42, 0x56, 0x42, 0x34, 0x64, 0x39, 0x65, 0x62, /* BVB4d9eb */
                                        0x64, 0x62, 0x65, 0x2d, 0x30, 0x64, 0x35, 0x64, /* dbe-0d5d */
                                        0x62, 0x32, 0x39, 0x36, 0x20, 0x00, 0x00, 0x00, /* b296 ... */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
...
void construct_eap_response_md5_challenge_frame(const uint8_t *frame)
{
  ...
  const uint8_t eapol_version[] = {0x01};
  const uint8_t eapol_type[] = {0x00}; // type: eapol start
  const uint8_t eapol_frame_length[] = {0x00, 0x1f};
  const uint8_t eap_id = frame[EAP_ID_ADDRESS_IN_EAP_MD5_REQUEST_FRAME];
  const uint8_t eap_header[] = {0x02, eap_id, 0x00, 0x1f};
...
//uint8_t eap_response_md5_value[EAP_MD5_VALUE_LENGTH]; // md5 calculation result
  ...
  extern unsigned int midnight_mode_change_tail_data;
    ...
    const uint8_t ethernet_padding[] = {    0xff, 0xff, 0x37, 0x77, 0xff, 0xaf, 0xf7, 0xff, 0xe5, 0x00, 0xff};
    const uint8_t ethernet_trailer[] = {   0xff, 0xff, 0xaf, 0xf7, /* ........ */
                                           0xff, 0x80, 0x01, 0xff, 0xff, 0x53, 0x3e, 0x4a, /* .....S>J */
                                           ...
                                           0xd0, 0x00, 0x00, 0x13, 0x11, 0x01, 0xc4, 0x1a, /* ........ */
                                           0x0c, 0x00, 0x00, 0x13, 0x11, 0x18, 0x06, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x1a, 0x0e, 0x00, 0x00, 0x13, /* ........ */
                                           0x11, 0x2d, 0x08, 0x08, 0x00, 0x27, 0x69, 0x25, /* .-...'i% */
                                           0x6a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, 0x2f, /* j....../ */
                                           0x12, 0x58, 0xae, 0xb1, 0x67, 0x19, 0xe5, 0x5f, /* .X..g.._ */
                                           0x4f, 0xec, 0x7a, 0xf9, 0xd3, 0xb1, 0x6d, 0xba, /* O.z...m. */
                                           0x23, 0x1a, 0x08, 0x00, 0x00, 0x13, 0x11, 0x76, /* #......v */
                                           0x02, 0x1a, 0x09, 0x00, 0x00, 0x13, 0x11, 0x35, /* .......5 */
                                           0x03, 0x02, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                           ...
                                           0x00, 0x00, 0x0a, 0x00, 0x27, 0xff, 0xfe, 0x69, /* ....'..i */
                                           0x25, 0x6a, 0x1a, 0x18, 0x00, 0x00, 0x13, 0x11, /* %j...... */
                                           0x4e, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* N....... */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x1a, 0x88, 0x00, 0x00, 0x13, 0x11, /* ........ */
                                           0x4d, 0x82, 0x66, 0x39, 0x64, 0x63, 0x34, 0x34, /* M.f9dc44 */
                                           0x35, 0x37, 0x34, 0x34, 0x66, 0x33, 0x66, 0x62, /* 5744f3fb */
                                           0x39, 0x64, 0x33, 0x37, 0x34, 0x34, 0x65, 0x61, /* 9d3744ea */
                                           0x31, 0x66, 0x31, 0x39, 0x62, 0x64, 0x35, 0x61, /* 1f19bd5a */
                                           0x34, 0x34, 0x64, 0x39, 0x63, 0x36, 0x30, 0x34, /* 44d9c604 */
                                           0x31, 0x66, 0x33, 0x64, 0x30, 0x38, 0x64, 0x39, /* 1f3d08d9 */
                                           0x38, 0x30, 0x62, 0x62, 0x32, 0x31, 0x39, 0x62, /* 80bb219b */
                                           0x61, 0x63, 0x30, 0x30, 0x30, 0x32, 0x35, 0x37, /* ac000257 */
                                           0x39, 0x30, 0x38, 0x36, 0x32, 0x63, 0x38, 0x30, /* 90862c80 */
                                           0x36, 0x64, 0x62, 0x62, 0x39, 0x34, 0x65, 0x66, /* 6dbb94ef */
                                           0x62, 0x30, 0x63, 0x61, 0x64, 0x35, 0x63, 0x32, /* b0cad5c2 */
                                           0x35, 0x65, 0x30, 0x64, 0x63, 0x62, 0x32, 0x38, /* 5e0dcb28 */
                                           0x39, 0x36, 0x66, 0x34, 0x61, 0x33, 0x65, 0x66, /* 96f4a3ef */
                                           0x62, 0x39, 0x33, 0x32, 0x35, 0x64, 0x36, 0x63, /* b9325d6c */
                                           0x62, 0x35, 0x33, 0x66, 0x39, 0x62, 0x62, 0x35, /* b53f9bb5 */
                                           0x34, 0x35, 0x62, 0x62, 0x66, 0x39, 0x39, 0x39, /* 45bbf999 */
                                           0x66, 0x38, 0x1a, 0x28, 0x00, 0x00, 0x13, 0x11, /* f8.(.... */
                                           0x39, 0x22, 0xd2, 0xc6, 0xb6, 0xaf, 0x00, 0x00, /* 9"...... */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x1a, 0x48, 0x00, 0x00, 0x13, 0x11, /* ...H.... */
                                           0x54, 0x42, 0x56, 0x42, 0x34, 0x64, 0x39, 0x65, /* TBVB4d9e */
                                           0x62, 0x64, 0x62, 0x65, 0x2d, 0x30, 0x64, 0x35, /* bdbe-0d5 */
                                           0x64, 0x62, 0x32, 0x39, 0x36, 0x20, 0x00, 0x00, /* db296 .. */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* ........ */
